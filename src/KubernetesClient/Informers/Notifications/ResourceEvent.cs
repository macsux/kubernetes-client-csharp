...
namespace k8s.Informers.Notifications
{
    ...
    public struct  ResourceEvent<TResource>
    {
        ...
        {
            bool includePrefix = Value != null && OldValue != null;
    ...
    public static class ResourceEventExtensions
    {
       ...
       /// <param name="emitEmpty">If <see langword="true"/> the resulting <see cref="IEnumerable{T}"/> will contain a single
       /// <see cref="ResourceEvent{TResource}"/> with no object value and <see cref="EventTypeFlags.ResetEmpty"/> flag set</param>
