    ...
    public class KubernetesResourceInformerTests : IDisposable
    {
        ...
        public void Watch_InterruptedWatchAndGoneResourceVersion_ShouldReList()
        {
            ...
            kubernetes.ListWithHttpMessagesAsync<V1Pod>(
                ...
                .Returns(
                _ => TestData.TestPod1ResourceVersion1.ToWatchEvent(WatchEventType.Added).ToHttpOperationResponse(),
                _ => new HttpOperationResponse<KubernetesList<V1Pod>>() {Response = new HttpResponseMessage() {StatusCode = HttpStatusCode.Gone}});
